...
const offersController = {
    ...
    offersDashboard : async (req, res, next) => {
    ...
    candidatesInOffer : async (req, res) => {
        try {
    ...
    companyRejectCandidate : async (req, res) => {
        try {
    ...
    postJobOffer : async (req, res, next) => {
    ...
    requestCandidateInfo : async (req, res) => {
        try {
