...
const recommendations = {
    getUserRecommendationsDashboard: async (req, res) => {
    ...
    influencerUserRecommendation: async (req, res) => {
    ...
    companyUserRecommendation: async (req, res) => {
    ...
    candidatesInProcess: async (req, res) => {
    ...
    validateCandidate: async (req, res) => {
    ...
    candidateAcceptRec: async (req, res) => {
    ...
    setCandidateInProcess: async (req, res) => {
    ...
    setCandidateHired: async (req, res) => {
